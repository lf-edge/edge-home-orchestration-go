...
func (m *MockDBInterface) Get(id string) (configuration.Configuration, error) {
	m.ctrl.T.Helper()
...
func (m *MockDBInterface) GetList() ([]configuration.Configuration, error) {
	m.ctrl.T.Helper()
...
func (m *MockDBInterface) Set(conf configuration.Configuration) error {
	m.ctrl.T.Helper()
...
func (m *MockDBInterface) Update(conf configuration.Configuration) error {
	m.ctrl.T.Helper()
