...
// Source: internal/db/helper/helper.go
...
func (mr *MockMultipleBucketQueryMockRecorder) GetDeviceID() *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetDeviceID", reflect.TypeOf((*MockMultipleBucketQuery)(nil).GetDeviceID))
}
