...
import (
	resource "github.com/lf-edge/edge-home-orchestration-go/internal/db/bolt/resource"
	reflect "reflect"
...
func (m *MockDBInterface) Get(id string) (resource.ResourceInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(resource.ResourceInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockDBInterface) Set(info resource.ResourceInfo) error {
	m.ctrl.T.Helper()
