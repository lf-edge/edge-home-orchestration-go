...
Please download [edge-orchestration](https://github.sec.samsung.net/RS7-EdgeComputing/edge-home-orchestration-go/releases/download/alpha/edge-orchestration.tar)
...
- **[edge_orchestration_api.yaml](https://./doc/edge_orchestration_api.yaml)**
